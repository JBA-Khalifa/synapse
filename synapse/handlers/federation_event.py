...
class FederationEventHandler:
    ...
    async def process_remote_join(
        ...
        Args:
            ...
            room_id: The room that we believe the join event is for
            auth_events: the auth_events returned by send_join
            state: the state returned by send_join
            event: the join event itself.
